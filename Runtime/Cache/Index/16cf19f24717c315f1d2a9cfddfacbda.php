...
<div id="content-header" class="page-header">
		...
		<!-- /BREADCRUMBS -->
			<div class="clearfix">
				<h3 class="content-title pull-left">路由编辑</h3>
			</div> 
	  ...
	  <div class="row-fluid">
       ...
       <div class="box-body big">
 		...
 		<form class="form-horizontal" name='form' action="<?php echo U('editroute');?>" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">路由标记名称 :</label>
				<div class="col-sm-7">
				  <!-- <input type="text" class="span11" placeholder="输入路由标记名称"  name="shopname" id="shopname" value="<?php echo ($info["shopname"]); ?>" /> -->
				  <input class="form-control" placeholder="商户名称"   value="<?php echo ($info["routename"]); ?>" name="routename" id="routename" type="text" />
            ...
            <div class="form-group" id="wxacc">
				<label class="col-sm-2 control-label">路由器MAC  :</label>
				<div class="col-sm-7">
				  <!-- <input type="text" class="span11" placeholder="输入路由标记名称"  name="shopname" id="shopname" value="<?php echo ($info["shopname"]); ?>" /> -->
				  <input class="form-control" placeholder="输入路由mac"   value="<?php echo ($info["gw_id"]); ?>" name="gw_id" id="gw_id"  type="text" />
                <span class="help-block">路由器MAC :</span> 
				</div>
			  </div>
