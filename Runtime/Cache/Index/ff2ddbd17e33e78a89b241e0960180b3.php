...
<div id="content" class="col-lg-12">
  ...
  <div id="content-header" class="page-header">
		...
		<!-- /BREADCRUMBS -->
			<div class="clearfix">
				<h3 class="content-title pull-left"><span><i class="fa-th icon-spin "></i>&nbsp;&nbsp;</span>认证模板设置</h3>
			</div> 
	  ...
	  <div  class="container-fluid">
	   ...
	   <div class="col-md-12">
		...
		<div class="box-title">
         ...
         <h4><i class="fa fa-bars"></i>认证模板</h4>
        </div>
		</div>
       ...
       <!--  <div class="widget-content tab-content"> -->
            <div id="tab1" class="tab-pane active">
            	...
            	<?php if(is_array($tpl)): $i = 0; $__LIST__ = $tpl;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i; if($list['group'] == 1): ?><li <?php if(($info['tpl_id']) == $list['id']): ?>class="active"<?php endif; ?>>
											<label>
											<img  src="<?php echo ($Theme['P']['root']); ?>/images/webtpl/<?php echo ($list['pic']); ?>"><input class="radio" type="radio" name="optype" value="<?php echo ($list['id']); ?>"
