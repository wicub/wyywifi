...
<div id="content" class="col-lg-12">
  ...
  <!-- <div id="content-header">
   ...
   <div id="content-header" class="page-header">
				...
				<!-- /BREADCRUMBS -->
					<div class="clearfix">
						<h3 class="content-title pull-left"><span><!-- <i class="fa-phone icon-spin "></i> -->&nbsp;&nbsp;</span>活动发布</h3>
					</div> 
  ...
  <!-- <div class="container-fluid">
		    ...
		    <div class="row-fluid">
		      <div class="span12"> -->
		  <div class="col-md-12">
             <div class="form-group"><a href="<?php echo U('user/addactlog');?>" class="btn btn-success">添加活动</a></div>
			 
			 <div class="box border blue">
			    <div class="box-title">
						<h5><i class="fa fa-table"></i>活动列表</h5>
            ...
            <!-- <table class="table table-bordered table-striped">
			 ...
			 <div class="box-body">
           	...
           	<?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
	        			...
	        			<td><?php echo (date('Y-m-d ',$vo["add_time"])); ?></td>
	        			<td><?php echo ($vo["sort"]); ?></td>
	        			<td><a href="<?php echo U('editactlog',array('id'=>$vo['id']));?>" class="btn btn-primary btn-mini">编辑</a>&nbsp;&nbsp;<a href="javascript:drop_confirm('您确定要删除吗?','<?php echo U('web/delcatelog',array('id'=>$vo['id']));?>');" class="btn btn-danger btn-mini">删除</a> </td>
	        			</tr><?php endforeach; endif; else: echo "" ;endif; ?>
