             ...
             <div class="form-group">
              ...
              <div class="col-sm-10">
				 ...
				 <select name="sh" id="sh" class="col-md-2" >
                  <?php $__FOR_START_29822__=0;$__FOR_END_29822__=24;for($i=$__FOR_START_29822__;$i < $__FOR_END_29822__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if(($info['sh']) == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>:00点</option><?php } ?>      
                  </select>
				...
				<select name="eh" id="eh" class="col-md-2">
                  	<?php $__FOR_START_11743__=0;$__FOR_END_11743__=24;for($i=$__FOR_START_11743__;$i < $__FOR_END_11743__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if(($info['eh']) == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>:00点</option><?php } ?>
                  </select>
