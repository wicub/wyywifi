...
<div id="content" class="col-lg-12">
  <!-- <div id="content-header">
	...
	<div id="content-header" class="page-header">
				...
				<!-- /BREADCRUMBS -->
					<div class="clearfix">
						<h3 class="content-title pull-left"><span><i class="fa-group icon-spin "></i>&nbsp;&nbsp;</span>路由管理</h3>
					</div> 
  ...
  <!-- <div class="container-fluid">
		...
		<div class="col-md-12">
          ...
          <!--   <div class="form-group"><a href="<?php echo U('User/addroute');?>" class="btn btn-success">添加路由</a></div> -->
        ...
        <!-- <div class="widget-box">
		  ...
		  <div class="box-title">
			<h5><i class="fa fa-table"></i>路由列表</h5>
...
<!--             <table class="table table-bordered table-striped">
			...
			<div class="box-body">
               ...
               <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if(($mod) == "1"): ?>even gradeC<?php else: ?>odd gradeX<?php endif; ?>">
	        			...
	        			<td><?php echo (date('Y年m月d日 H:i',$vo["last_heartbeat_time"])); ?></td>
	        			<td>
						<a href="<?php echo U('mangeroute',array('id'=>$vo['id']));?>" class="btn btn-info btn-mini">管理</a>&nbsp;&nbsp;
					<!-- 	<a href="<?php echo U('editroute',array('id'=>$vo['id']));?>" class="btn btn-primary btn-mini">编辑</a>&nbsp;&nbsp; -->
						<a href="javascript:drop_confirm('您确定要删除吗?','<?php echo U('user/delrout',array('id'=>$vo['id']));?>');" class="btn btn-danger btn-mini">删除</a> &nbsp;&nbsp;
